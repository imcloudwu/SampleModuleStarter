...
/// This is base class for holding XML structure. You can access its structure by using subscript like this: element["foo"]["bar"] would return <bar></bar> element from <element><foo><bar></bar></foo></element> XML as an AEXMLElement object.
SWIFT_CLASS("_TtC16ischoolFramework12AEXMLElement")
...
@property (nonatomic, readonly, strong) AEXMLElement * __nullable first;

/// Returns the last element with equal name as self (nil if not exists).
@property (nonatomic, readonly, strong) AEXMLElement * __nullable last;
...
/// This class is inherited from AEXMLElement and has a few addons to represent XML Document. XML Parsing is also done with this object.
SWIFT_CLASS("_TtC16ischoolFramework13AEXMLDocument")
...
@property (nonatomic, readonly, strong) AEXMLElement * __nonnull root;
...
@interface NSData (SWIFT_EXTENSION(ischoolFramework))
@property (nonatomic, readonly, copy) NSString * __nonnull stringValue;
@end


@interface NSNumber (SWIFT_EXTENSION(ischoolFramework))
@end


@interface UIImage (SWIFT_EXTENSION(ischoolFramework))
@end


@interface UITableView (SWIFT_EXTENSION(ischoolFramework))
- (void)reloadDataWithAnimated;
@end

@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC16ischoolFramework15ischoolViewCtrl")
@interface ischoolViewCtrl : UIViewController
@property (nonatomic, copy) NSString * __nullable navtitle;
- (void)viewDidLoad;
